...
document.querySelector(".article-me-info-stats-info-text1").innerHTML =
  "<span>S</span>teve was a young British boxer enjoying his run as the middleweight champion of the world. Adopted during infancy, Steve sought the identity of his biological parents, as well as the origin of the scar on his arm.";
...
mod2.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>A</span> student of Taekwondo who works out at Baek Doo San's dojang, Hwoarang makes a lot of money through dishonest gambling wagers. As part of what's called a fraud team, he and other members pick fights for money.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod4.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-nome").innerHTML =
    "Jin Kazama";
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>J</span>in Kazama is the son of Jun Kazama and Kazuya Mishima. During Jun's pregnancy, part of Kazuya's Devil, (which fled Kazuya when he was thrown into a volcano by his father) attempted to possess Jin, who inherited his father's Devil Gene.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod5.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>K</span>ing used to be a street brawling orphan with no care in the world except fighting. In one of his fights, King was grievously wounded and collapsed in front of a monastery. The Marquez priests took him in, saving him from death.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod6.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-nome").innerHTML =
    "Ling Xiaoyu";
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>L</span>ing Xiaoyu was a young, talented martial artist who dreamed of building the perfect theme park in China. Her teacher and distant relative, Wang Jinrei, told her about Heihachi Mishima, owner of the wealthy and resource-rich Mishima Zaibatsu.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod7.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-nome").innerHTML =
    "Anna Williams";
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>A</span>longside her sister, Nina Williams, Anna was taught assassination arts by her father and Aikido by her mother.[1] Anna developed a deadly rivalry with Nina, and the two would often attempt to humiliate or kill one another.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod8.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-nome").innerHTML =
    "Nina Williams";
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>N</span>ina and her younger sister are from a family of assassins, and both hail from the Republic of Ireland, Nina is cold and indifferent, and ruthlessly efficient in her work. She has been the subject of numerous experiments.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
...
mod9.addEventListener("click", function () {
  ...
  document.querySelector(".article-me-info-stats-nome").innerHTML =
    "Michelle Chang";
  document.querySelector(".article-me-info-stats-info-text1").innerHTML =
    "<span>M</span>ichelle Chang is a young Native American woman of mixed descent, from Arizona. Michelle learns from her mother that her father has been killed by Heihachi's men. Outraged, Michelle entered the first King of Iron Fist Tournament determined to exact revenge on Heihachi.";
  document.querySelector(".article-me-info-stats-info-text2").innerHTML =
